  ...
  <div class="cart-item d-flex gap-4 align-items-center p-3 position-relative rounded">
    ...
    <div class="content">
      ...
      <div class="bottom">
        <div class="price">
          <p>TODAY'S PRICE:</p>
          <h4>£{{ item.totalPrice.toFixed(2) }} <span>£10.90</span></h4>
        </div>
        <div class="qty d-flex gap-3 align-items-center p-1 position-relative rounded-5">
    ...
    <!-- CLOSE -->
    <button
      class="close position-absolute top-0 end-0 border-0 bg-transparent fs-4"
...
.qty {
  background-image: url("../../../assets/images/incdecbg.png");
  @include bg_no_repeat_cover_center;
