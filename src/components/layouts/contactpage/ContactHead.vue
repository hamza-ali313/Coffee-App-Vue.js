   ...
   <div class="faq-section position-relative">
        <div class="container">
            ...
            <div class="filtersec sec_heading text-center py-4 px-3">
                ...
                <p style="padding:unset" class="text-center mt-4">
                    Whether you have a question about our menu, an event, or just want to share your thoughts, we’re here to help.
                </p>
            </div>
        </div>
    </div>
