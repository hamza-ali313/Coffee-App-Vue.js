<template>
  <div class="menu-page container py-5">
    ...
    <div class="filters d-flex justify-content-center gap-1 mb-4">
      ...
      <!-- toggle -->
      <p
        class="form-check form-switch d-flex justify-content-center align-items-center gap-5"
      >
    ...
    <div v-for="section in filteredSections" :key="section.title" class="mb-5">
      <div
        v-if="section.filteredCategories.length"
        class="lefthl sec_heading mb-3 py-4 px-3"
      >
...
const sections = ref([
  {
    title: "Foods",
    titledesc:
      "Dee’s Foods are crafted with quality ingredients and calm attention to detail.",
    categories: [
      {
        title: "Morning Bowls",
...

  {
    title: "Drinks",
    titledesc:
      "Dee’s drinks are crafted with quality ingredients and calm attention to detail.",
    categories: [
      {
        title: "Hot Coffee",
        ...
        items: [
          { name: "Espresso", desc: "Single or double shot", price: 5.9, tags: [] },
          { name: "Americano", desc: "Espresso with hot water", price: 11.8, tags: [] },
          { name: "Flat White", desc: "Velvety micro-foam", price: 8.7, tags: [] },
          { name: "Latte", desc: "Smooth and milky", price: 12.5, tags: [] },
          { name: "Cappuccino", desc: "Foamy and rich", price: 6.7, tags: [] },
          { name: "Mocha", desc: "Coffee with chocolate", price: 8.9, tags: [] },
        ],
      },

      {
        ...
        items: [
          {
            name: "Brunch Tea (Black)",
            desc: "Assam + Darjeeling blend",
            price: 12.5,
            tags: [],
          },
          {
            name: "Earl Grey Goût Russe (Black)",
            desc: "Citrus bergamot tea",
            price: 6.7,
            tags: [],
          },
          {
            name: "Coquelicot Gourmand (Black)",
            desc: "Gourmet black tea with fruity notes",
            price: 8.9,
            tags: [],
          },
          {
            name: "Miss Dammann (Green)",
            desc: "Green tea with ginger, passion fruit and lime",
            price: 5.9,
            tags: [],
          },
          {
            name: "Bali (Green)",
            desc: "Green tea with lychee, grapefruit, peach",
            price: 11.8,
            tags: [],
          },
          {
            name: "Jasmin Chung Hao (Green)",
            desc: "Jasmine green tea",
            price: 8.7,
            tags: [],
          },
          {
            name: "Bella Blanca (White)",
            desc: "White tea with mango, bergamot and almond",
            price: 12.5,
            tags: [],
          },
          {
            name: "Passion de Fleurs (White)",
            desc: "White tea with rose, apricot and passion fruit",
            price: 6.7,
            tags: [],
          },
        ],
...

      {
        ...
        items: [
          {
            name: "Rooibos Jardin Bleu",
            desc: "Rooibos with rhubarb & strawberry",
            price: 11.8,
            tags: [],
          },
          {
            name: "Rooibos Citrus",
            desc: "Rooibos with lemon, clementine and orange",
            price: 8.7,
            tags: [],
          },
          {
            name: "Rooibos Vanille",
            desc: "Rooibos with vanilla notes",
            price: 12.5,
            tags: [],
          },
          {
            name: "Rooibos Earl Grey",
            desc: "Rooibos with bergamot notes",
            price: 6.7,
            tags: [],
          },
          {
            name: "Carcadet Provence",
            desc: "Hibiscus infusion with apricot & peach",
            price: 12.5,
            tags: [],
          },
          {
            name: "Carcadet Nuit d'été",
            desc: "Hibiscus with raspberry, cream & strawberry",
            price: 6.7,
            tags: [],
          },
          {
            name: "Passion Framboise",
            desc: "Hibiscus with raspberry & passion fruit",
            price: 8.9,
            tags: [],
          },
          {
            name: "Cacao Orange",
            desc: "Cocoa nibs with orange zest",
            price: 5.9,
            tags: [],
          },
        ],
        ...
        items: [
          {
            ...
            desc: "Rich chocolate drink",
            price: 8.7,
            tags: ["Kids"],
          },
          {
            name: "Dark Hot Chocolate",
            desc: "More intense cocoa profile",
            price: 12.5,
            tags: [],
          },
          {
            name: "Mocha Hot Chocolate",
            desc: "Hot chocolate with espresso shot",
            price: 6.7,
            tags: [],
          },
          {
