<template>
    <div class="pairs_with_sec">
        ...
        <div class="container slider position-relative">
            ...
            <!-- Swiper -->
            <swiper :slides-per-view="4" :space-between="10" :breakpoints="breakpoints" :observer="true"
                :modules="modules" :observe-parents="true" :watch-slides-progress="false"
...
.pairs_with_sec {
    ...
    &::before {
        content: "";
        position: absolute;
        background-image: url("@/assets/images/pairbef.png");
        background-repeat: no-repeat;
        background-size: contain;
        top: 0;
        left: 0;
    ...
    &::after {
        content: "";
        position: absolute;
        background-image: url("@/assets/images/pairafter.png");
        background-repeat: no-repeat;
        background-size: contain;
        bottom: 0;
        right: 0;
